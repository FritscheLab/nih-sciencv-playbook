---
title: References (official + institutional)
nav_order: 11
---
...
- [Disclaimer (not official guidance)]({{ site.baseurl }}{% link disclaimer.md %})
...
- [NIH Nexus: Will my application be withdrawn if I don't use the Common Forms?](https://grants.nih.gov/news-events/nih-extramural-nexus-news/2026/03/will-my-application-be-withdrawn-if-i-dont-use-the-common-forms)

## NIH official pages (forms + explainers)
...
- [NIH Nexus: What should I know about the new Biographical Sketch Common Form?](https://grants.nih.gov/news-events/nih-extramural-nexus-news/2026/03/what-should-i-know-about-the-new-biographical-sketch-common-form)
- [NIH Nexus: What should I know about the CPOS Common Form?](https://grants.nih.gov/news-events/nih-extramural-nexus-news/2026/04/what-should-i-know-about-the-current-and-pending-other-support-cpos-common-form)
...
- [NLM Support: Troubleshooting CPOS XML upload errors (KA-05498)](https://support.nlm.nih.gov/kbArticle/?pn=KA-05498)
- [SciENcv Data Schemas](https://www.ncbi.nlm.nih.gov/sciencv/data-schemas/)


## NSPM-33 / research security references

- [NSF NSPM-33 implementation guidance and disclosure requirements](https://www.nsf.gov/policies/nspm-33)
- [NSF NSPM-33 definitions](https://www.nsf.gov/policies/nspm-33/definitions)
- [OSTP policy regarding use of common disclosure forms](https://bidenwhitehouse.archives.gov/ostp/news-updates/2024/02/14/policy-regarding-use-of-common-disclosure-forms/)

## Examples of institutional guides

These are not official NIH instructions, but they often provide practical screenshots and workflow tips.

- [Stanford ORA — NIH implementation of Common Forms (effective Jan 25, 2026)](https://ora.stanford.edu/resources/disclosure-resources/national-institutes-health-nih/nih-implementation-common-forms)
- [Yale — SciENcv & Common Forms](https://research-support.yale.edu/sponsored-projects/office-of-sponsored-projects/policies-compliance/sciencv-common-forms)
- [NC State University Libraries — SciENcv for Biosketches](https://www.lib.ncsu.edu/sciencv-for-biosketches)
- [UCSF OSR — NIH implementation news item](https://osr.ucsf.edu/news/nihs-implementation-of-common-forms-for-biographical-sketch-and-current-and-pending-other-support)
- [Washington University in St. Louis — implementation announcement](https://research.washu.edu/announcements/nihs-implementation-of-common-forms-for-biographical-sketch-and-current-and-pending-other-support/)
- [Emory — SciENcv EPC flyer (PDF)](https://rcra.emory.edu/_includes/documents/sections/research-security/sciencv-epc-flyer.pdf)
- [Georgia Tech OSP — Adding Delegates to SciENcv (PDF)](https://osp.gatech.edu/sites/default/files/inline-files/Adding%20Delegates%20to%20SciENcv.pdf)

(Expand this list for your institution and add your local SOP links.)
