...
Three related requirements use different evidence and submission points. Track them separately.
...
- collect a separate certification from **each senior/key person**;
- use NIH’s required statement: “I [insert name] certify that, at the time of submission, I am not a party to a malign foreign talent recruitment program.”
- upload it in **Section G.1, Special Notice of Award and Funding Opportunity Announcement Reporting Requirements**;
- flatten that statement PDF as required; and
- name each file `MFTRPcert_[Name].pdf`, replacing `[Name]` with the senior/key person’s name.

{: .warning }
> The annual MFTRP statement is a **separate RPPR attachment**. It does not replace the Common Form certification, and it is not appended to or used to flatten the SciENcv biosketch or CPOS PDF.
...
Official sources: [NOT-OD-26-017](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-26-017.html), [NOT-OD-26-018](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-26-018.html), [NOT-OD-26-079](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-26-079.html), [NIH RPPR Instruction Guide](https://grants.nih.gov/sites/default/files/rppr_instruction_guide.pdf), and [NOT-OD-25-133](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-25-133.html).
